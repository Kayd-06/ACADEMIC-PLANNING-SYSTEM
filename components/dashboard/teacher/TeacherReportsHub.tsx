...
import TeacherDailyReportView from './TeacherDailyReportView'
import ProgressReportView from '../management/ProgressReportView'
  ...
  return (
    <div className="flex-1 flex flex-col min-w-0 bg-gray-50/50">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {activeTab === 'daily' ? <TeacherDailyReportView /> : <ProgressReportView />}
      </div>
    </div>
  )
}
