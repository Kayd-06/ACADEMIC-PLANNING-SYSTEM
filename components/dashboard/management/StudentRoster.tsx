      ...
      <motion.div {...fadeUp(0)} className="flex items-start justify-between mb-8">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 px-3 py-2 text-sm text-red-600 border border-red-200 bg-red-50 hover:bg-red-100 rounded-xl shadow-sm transition-all font-semibold"
          >
